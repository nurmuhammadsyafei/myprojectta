...
<body>
  ...
  <div class="container_custom">
    <div class="text-center bold h4">
      Tabel Perkembangan Jumlah Pendaki Pertahun
    </div>
  </div>
  <div class="container_custom">
    <table class="text-center center m-auto" style="border: 2px solid black">
     <thead style="background-color: rgba(47, 54, 64,1.0);color: white;">
      <tr>
       <th class="bord">No</th>
       <th class="bord" style="padding-left: 100px; padding-right: 100px;">Tahun</th>
       <th class="bord"style="padding-left: 75px; padding-right: 75px;">Jumlah Pendaki</th>
       <th class="bord"style="padding-left: 75px; padding-right: 75px;">Profit</th>
     </tr>
   </thead>
   <tbody>
    <?php 
    ...
    foreach ($tahunan as $thn): ?>
      <tr>
       ...
       <th class="ml-3 pr-3 bord"><?= $thn['tahun'] ?></th>
       <th class="pl-3 pr-3 bord"><?= $this->custom_library->rupiah($thn['pendaki']) ?></th>
       <th class="text-center pl-3 pr-3 bord">Rp.<?= $this->custom_library->rupiah($thn['profit']) ?></th>
     </tr>
   <?php endforeach ?>
 </tbody>
</table>
