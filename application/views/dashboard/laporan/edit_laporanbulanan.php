  ...
  <div class="col-md-4">
    ...
    <form class="user" method="post" action="<?= base_url('cdashboard/edit_lap_bulanan'); ?>">
      ...
      <div class="form-group">
        ...
        <input name="_tahun" type="text" readonly class="ml-3 mb-2 form-control-custom" value="<?= $byid['thn'] ?>">
        <b class="mb-0">Bulan</b>
        <input name="_bulan" type="text" readonly class="ml-3 mb-2 form-control-custom" value="<?= $byid['bln'] ?>">
        <b class="mb-0">Jumlah Pendaki</b>
        <input name="_pendaki" type="text" required class="ml-3 mb-2 form-control-custom" value="<?= $byid['pendaki'] ?>">
